...
| LAN | 	From UBUNTU, access the WINDOWS host with `telnet 192.168.11.7 21` then enter: `USER Administrator` then `PASS napier123` and then `QUIT` | 	Outline the messages that you received: What happens to each of these when you try with an incorrect username and password: | 
