...
Time for test: **Thursday, 6 November 2025** (6-8pm, Clusters 1-4, JKCC). Some students will use either C27, C28 or C30 (you should receive a Teams message if you are using one of these rooms).
