...
Time for test: **6-8pm, Thursday, 8 November 2028** (Clusters 1-4, JKCC). Some students will use either C27, C28 or C30 (you should receive a Teams message if you are using one of these rooms).
