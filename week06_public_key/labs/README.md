...
Finally, change the program so that it does 256-bit AES with CBC mode.
            ...
            <h2>AWS: Public Key Encryption</h2>


            <p>In the following figure, Bob uses Alice’s public key to encrypt data, and which creates ciphertext. Alice then decrypts this ciphertext with her private key:</p>
            <p><img src="/public/kms_10.png" width="750px" /></p>
            ...
            <pre>
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            <p><img src="/public/kms_16.png" width="750px" /></p>
...
% aws kms get-public-key --key-id alias/PublicKeyForDemo
{
    ...
    "EncryptionAlgorithms": [
        ...
        "RSAES_OAEP_SHA_256"
            ...
            <h2>Encrypting with the public key</h2>

            <p>We can now create a file (1.txt):</p>
            <p><img src="/public/kms_17.png" width="750px" /></p>
...
5
            ...
            <h2>Decrypting with the private key</h2>
...
This is my secret file.
            ...
            <p><img src="/public/kms_18.png" width="750px" /></p>
...
Plain: Hello
            ...
            <p><img src="/public/kms_19.png" width="750px" /></p>
