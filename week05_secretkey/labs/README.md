...
For a cipher text for 256-bit AES CBC and a message of “Hello” with a salt value of  “241fa86763b85341”, try the following passwords, and determine the password used for a ciphertext of “PxonB24+a9f3U/KmlB+/KA==”  |  [qwerty][inkwell][london][paris][cake]
|10 | Now, use the decryption method to prove that you can decrypt the ciphertext.

echo V60XNkEyAAF40k5rFSbrZw== \| openssl enc -aes-256-cbc -pass pass:"password" -d  -base64 -S 241fa86763b85341 | Did you confirm the right password? [Yes/No] |
| 11 | Investigate the following commands by running them several times:

echo -n "Hello" \| openssl enc -aes-128-cbc -pass pass:"london" -e -base64 -S 241fa86763b85341

echo -n "Hello" \| openssl enc -aes-128-cbc -pass pass:"london" -e -base64 -salt | What do you observe? Why do you think causes this? |
